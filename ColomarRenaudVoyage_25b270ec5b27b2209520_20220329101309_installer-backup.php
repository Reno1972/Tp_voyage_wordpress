...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'ColomarRenaudVoyage_25b270ec5b27b2209520_20220329101309_archive.zip';
	const ARCHIVE_SIZE		 = '55500724';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '25b270e-29101309';
    const SECONDARY_PACKAGE_HASH = '44be143-29101309';
	const VERSION			 = '1.4.4';
